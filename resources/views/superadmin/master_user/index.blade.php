...
<div class="card mb-4 shadow-sm">
  <div class="card-body">
    <h3 class="mb-3">Tabel User & Pegawai</h3>

    <!-- Form Pencarian & Tombol Tambah -->
    <div class="row mb-3 justify-content-end">
      <div class="col-md-12 col-lg-12 d-flex justify-content-end">
        <form method="GET" action="{{ route('superadmin.master_user.index') }}" class="d-flex me-2 flex-grow-1">
        ...
        <button class="btn btn-primary text-nowrap" data-bs-toggle="modal" data-bs-target="#createModal">Tambah User</button>
      </div>
    </div>
