...
<div x-data="{ tab: 'kegiatan' }" class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white shadow rounded-lg p-4 border-l-4 border-blue-600">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-sm text-blue-600 font-medium uppercase">Total Tugas Tim</p>
                    <h2 class="text-2xl font-bold text-gray-800">{{ $totalTugas }}</h2>
                </div>
        ...
        <div class="bg-white shadow rounded-lg p-4 border-l-4 border-green-600">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-sm text-green-600 font-medium uppercase">Jumlah Anggota Tim</p>
                    <h2 class="text-2xl font-bold text-gray-800">{{ $jumlahPegawai }}</h2>
                </div>
        ...
        <div class="bg-white shadow rounded-lg p-4 border-l-4 border-yellow-500">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-sm text-yellow-600 font-medium uppercase">Anggota Teraktif</p>
                    <h2 class="text-2xl font-bold text-gray-800">{{ $mostActive->nama ?? '-' }}</h2>
                </div>
    ...
    <!-- FILTER Bulan & Tahun -->
    <form method="GET" action="{{ route('admin.dashboard') }}" class="flex flex-wrap items-center gap-2 mb-4">
        <!-- Bulan -->
    ...
    <div class="mb-4 flex flex-wrap gap-2">
        <button @click="tab = 'kegiatan'" :class="tab === 'kegiatan' ? 'bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-medium shadow-sm transition' : 'bg-white text-blue-600 border border-blue-600'"
            class="px-4 py-1 rounded-full text-sm font-medium shadow-sm transition">
            Jumlah Kegiatan Tim
        </button>
        <button @click="tab = 'bobot'" :class="tab === 'bobot' ? 'bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-medium shadow-sm transition' : 'bg-white text-blue-600 border border-blue-600'"
            class="px-4 py-1 rounded-full text-sm font-medium shadow-sm transition">
            Jumlah Bobot Pekerjaan Tim
        </button>
        <button @click="tab = 'kinerja'" :class="tab === 'kinerja' ? 'bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-medium shadow-sm transition' : 'bg-white text-blue-600 border border-blue-600'"
            class="px-4 py-1 rounded-full text-sm font-medium shadow-sm transition">
            Nilai Kinerja Tim
        </button>
        <button @click="tab = 'persen'" :class="tab === 'persen' ? 'bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-medium shadow-sm transition' : 'bg-white text-blue-600 border border-blue-600'"
            class="px-4 py-1 rounded-full text-sm font-medium shadow-sm transition">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ambil data dari Controller (Blade)
    ...
    if (chartData.length > 30) {
        canvas.width = chartData.length * 40; // auto resize kalau pegawai banyak
    }
